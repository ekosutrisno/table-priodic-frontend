...
<script>
import MansoryDataSN from '@/assets/data/MansoryDataSN'
import SNGaleryHeader from '@/components/header/SNGaleryHeader'
export default {
  components: { SNGaleryHeader },
  data () {
    return {
      imgsArr: MansoryDataSN
    }
  }
}
</script>
